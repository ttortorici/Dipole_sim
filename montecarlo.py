...
class DipoleSim:
    def __init__(self, a: float, rows: int, columns: int, temp0, field0,
                 dipole_strength: float, orientations_num: int, eps_rel: float, p=None):
        """
        Monte Carlo
        ...
        :param field0: initial electric field
